...
# Доля экрана по высоте для поиска рекламных крестиков (0.25 = верхние 25%)
# Рекламные крестики почти всегда расположены в верхней части экрана
AD_SEARCH_REGION_RATIO = 0.25
